...
public class CurriculumVitaeSkillAddedDomainEventHandler
    : INotificationHandler<CurriculumVitaeSkillAddedDomainEvent>
{
    ...
    public CurriculumVitaeSkillAddedDomainEventHandler(
    ...
    public async Task Handle(
        CurriculumVitaeSkillAddedDomainEvent notification,

...
public class JobApplicationCreatedDomainEventHandler
    : INotificationHandler<JobApplicationCreatedDomainEvent>
{
    ...
    public async Task Handle(JobApplicationCreatedDomainEvent notification, CancellationToken cancellationToken)
    {
        ...
        _outbox.Enqueue(
            JobApplicationSnapshotMapper.ToCreatedEvent(readModel),
            AggregateType,

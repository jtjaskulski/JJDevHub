...
public class CurriculumVitaeUpdatedDomainEventHandler
    : INotificationHandler<CurriculumVitaeUpdatedDomainEvent>
{
    ...
    public CurriculumVitaeUpdatedDomainEventHandler(
    ...
    public async Task Handle(
        CurriculumVitaeUpdatedDomainEvent notification,
